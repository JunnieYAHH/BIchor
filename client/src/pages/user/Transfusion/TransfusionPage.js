                                    ...
                                    <div className="container">
                                        <div style={{ display: 'flex', alignItems: 'center' }}>
                                            ...
                                            <div style={{ marginLeft: '20px', padding: '20px', background: '#f0f0f0', border: '2px solid #333', borderRadius: '10px', boxShadow: '0 0 10px rgba(0, 0, 0, 0.1)' }}>
                                                <p style={{ fontWeight: 'bold', fontSize: '24px', textAlign: 'center' }}>Blood Transfusion? Apply Here!</p>
                                                <p style={{ textAlign: 'center' }}>
                                                    This will be the page that handles blood transfusion events that the local health centers post. We will be cooperating by creating an efficient way to process the blood donation.
                                                </p>
                                ...
                                <Row className="mb-4">
                                    <div className="container">
                                        <div style={{ textAlign: 'center', fontWeight: 'bold', fontSize: '24px', padding: '20px', background: '#f0f0f0', border: '2px solid #333', borderRadius: '10px', boxShadow: '0 0 10px rgba(0, 0, 0, 0.1)' }}>
                                            <p style={{ margin: '0' }}>TRANSFUSION</p>
                                        </div>
                                    </div>
